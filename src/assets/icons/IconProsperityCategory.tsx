...
function IconProsperityCategory(props: IIcon) {
    ...
    return (
        <svg className="icon--category icon--category--prosperity" data-category={category} width="49" height="49" viewBox="0 0 49 49" fill="none" xmlns="http://www.w3.org/2000/svg">
